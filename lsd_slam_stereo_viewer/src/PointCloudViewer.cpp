...
void PointCloudViewer::reset()
{
	...
	save_folder = ros::package::getPath("lsd_slam_stereo_viewer")+"/save/";
...
void PointCloudViewer::addFrameMsg(lsd_slam_stereo_viewer::keyframeMsgConstPtr msg)
{
	meddleMutex.lock();
...
void PointCloudViewer::addGraphMsg(lsd_slam_stereo_viewer::keyframeGraphMsgConstPtr msg)
{
	meddleMutex.lock();
