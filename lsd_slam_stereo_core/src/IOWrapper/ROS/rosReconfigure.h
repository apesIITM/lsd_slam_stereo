...
#include "lsd_slam_stereo_core/LSDParamsConfig.h"
#include "lsd_slam_stereo_core/LSDDebugParamsConfig.h"
...
void dynConfCbDebug(lsd_slam_stereo_core::LSDDebugParamsConfig &config, uint32_t level)
{
...
void dynConfCb(lsd_slam_stereo_core::LSDParamsConfig &config, uint32_t level)
{
